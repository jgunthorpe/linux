...
/*
 * This generates a memcpy that works on a a from/to address which is aligned to
 * bits. Count is in terms of the number of bits sized quantities to copy. It
 * optimizes to use the stp groupings when possible so that it is WC friendly.
 */
